...
export { default as regexp } from 'make-ui/util/regexp';
export * from 'make-ui/util/array';
export * from 'make-ui/util/css';
export * from 'make-ui/util/date';
export * from 'make-ui/util/element';
export * from 'make-ui/util/html';
export * from 'make-ui/util/is';
export * from 'make-ui/util/number';
export * from 'make-ui/util/object';
export * from 'make-ui/util/observe';
export * from 'make-ui/util/regexp';
export * from 'make-ui/util/string';
