...
const configBase = require(path.resolve(paths.appPath, 'config/webpack.base.js')); // 공통설정 (기본 프로젝트)
const configProduction = require(path.resolve(paths.appPath, 'config/webpack.production.js')); // 웹팩 배포용 설정 
const configDevelopment = require(path.resolve(paths.appPath, 'config/webpack.development.js')); // 웹팩 개발모드 설정 
